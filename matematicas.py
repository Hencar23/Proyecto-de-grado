...
class MatematicasFrame(tk.Frame):
    ...
    def _mostrar_menu(self):
        ...
        tk.Label(self, text="Matemáticas", font=("Helvetica", 22, "bold"), bg=self.cget("bg"), fg="#2e8b57").pack(pady=20)
    ...
    def _presentar_pregunta(self, pregunta, opciones, respuesta_correcta):
        ...
        for opt in opciones:
            crear_boton_grande(self, opt, command=lambda o=opt: self._verificar(o, respuesta_correcta)).pack(pady=5)
    ...
    def _quiz(self):
        ...
        self._limpiar()
        tk.Label(self, text="Quiz de Matemáticas", font=("Helvetica", 20, "bold"), bg=self.cget("bg"), fg="#2e8b57").pack(pady=10)
        preguntas = [
            ("5 + 2 = ?", "7"),
            ("10 - 3 = ?", "7"),
